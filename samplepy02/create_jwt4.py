...
api_to_call = 'https://ebrd-tst.smartkyc.ai/smartkyc/t/EBRD/api/LATEST/etc/flavor/settings'
...
api_to_call = 'https://smarteye.ebrd-tst.smartkyc.ai/smarteye/t/EBRD/api/LATEST/etc/flavor/settings'
